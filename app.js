...
document.getElementById('saveSheetBtn').onclick = () => {
  ...
  const sheetData = {
    ...
    /*
       ...
       The handwritten customer signature is NOT saved here.

       It only exists temporarily during PDF generation.
    */
...
/*
   ...
   Capture the signature temporarily.
...
document.getElementById(
  ...
  */
  ...
  /*
     Save the cropped signature temporarily.
  */
  capturedSignature =
...
function doExportPDF() {
  ...
  /*
     Signature is deliberately NOT placed here.

     The signature will be placed after the table and notes,
     where its position can be calculated properly.
  */
...
if (capturedSignature) {
  ...
  */
  ...
  /*
     The handwritten signature has now been used for this PDF.

     Remove it from memory so it is not accidentally reused
     by the next PDF export.
  */
  capturedSignature = null;
