...
// NEW EXTRA LINE (bigger, bold, with spacing)
const extraLine = "CERTIFICATE OF MAINTENANCE"; // <-- change this

pdf.setFont(undefined, 'bold');
pdf.setFontSize(12); // slightly bigger than address (which is 10)
pdf.text(extraLine, pageWidth/2, y, { align: 'center' });

y += 8; // spacing after the new line
